...
Spiltilstande:
1. **Blindsmagning (deduktion):** Appen viser en smagsprofil (farve, aroma, sødme, syre, tannin, alkohol, krop, eg, finish). Brugeren gætter sig trinvis frem: klima → drue → land → region → appellation. Der gives point pr. trin og forklaring bagefter.
